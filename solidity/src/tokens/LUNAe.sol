...
contract LUNAe is ERC20("Luna.e", "LUNA.e", 18) {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(msg.sender == VALIDATOR_ERC20_MODULE, "LUNAe: Only Validators");
        _mint(to, amount);
    }

    function burnCoins(address from, uint256 amount) public virtual {
        require(msg.sender == VALIDATOR_ERC20_MODULE, "LUNe: Only Validators");
        _burn(from, amount);
    }
}
